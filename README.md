...
Download FloatLyrics 0.3.1 for Ubuntu x64:

- [DEB installer](https://github.com/jasonnn404/FloatLyrics/releases/download/v0.3.1/FloatLyrics-0.3.1-linux-amd64.deb) — recommended for Ubuntu
- [AppImage](https://github.com/jasonnn404/FloatLyrics/releases/download/v0.3.1/FloatLyrics-0.3.1-linux-x86_64.AppImage) — portable version
...
- `release/FloatLyrics-0.3.1-arm64.dmg` for Apple Silicon Macs
- `release/FloatLyrics-0.3.1-x64.dmg` for Intel Macs
...
- `release/FloatLyrics-0.3.1-arm64.dmg`
- `release/FloatLyrics-0.3.1-x64.dmg`
