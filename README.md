...
- Spotify volume control on macOS, Windows, and Linux
- Smooth transitions when the active lyric line changes
- Readable color themes with custom text, background, accent, and opacity controls
